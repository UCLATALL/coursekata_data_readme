...
If you are reading this as a PDF, this PDF was created from the RMarkdown
notebook README.Rmd. If you open that file in RStudio you will be able to run
and interact with the code blocks below. Otherwise, happy reading!
...
code you can find a description of why each package is being loaded.
...
Data from the class is split into four tables with each table in its own file.
